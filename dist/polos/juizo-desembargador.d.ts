...
import { Polo } from '.';
export declare type TypeJuizoDesembargador = Deprecado | Deprecante | JuizoSentenciante | Jusrogante | JuizDeprecante | JustRog | Relator | Revisor;
export interface DictJuizoDesembargador {
    [name: string]: TypeJuizoDesembargador;
}
export declare const ObjectJuizoDesembargador: DictJuizoDesembargador;
declare const _default: Polo.JuizoDesembargador;
